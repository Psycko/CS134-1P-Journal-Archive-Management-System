...
export default function AdminLogin() {
    ...
    return (
        ...
        <div className="tw-bg-[url('/src/img/bg.jpg')] tw-flex tw-flex-wrap tw-justify-center tw-items-center tw-min-h-dvh tw-min-w-full tw-gap-x-16 tw-gap-y-px">
            ...
            <div class="md:tw-bg-gray-100 sm:tw-bg-gray-200 md:tw-bg-opacity-[40%] sm:tw-bg-opacity-[70%] tw-h-max tw-shadow-lg tw-rounded-lg">
                ...
                <form class="formStyle tw-w-96 tw-mx-auto tw-p-4">
                    ...
                    <div class="elements tw-p-2.5 tw-w-full tw-font-roboto">
                        <button type="button" class="lgnbutton tw-flex tw-justify-center tw-items-center tw-w-full tw-bg-btn-landing tw-rounded-md tw-h-[40px] tw-px-4 tw-border-none tw-outline-none hover:tw-bg-btn-dark tw-duration-500"
            ...
            <OTPModal onClose={handleOnClose} visible={showModal} />
        </div>
        </>
    )
}